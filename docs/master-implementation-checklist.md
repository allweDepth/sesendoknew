...
| 21 | Export resmi Renstra/Renja/RKA/DPA/perubahan/SPT/LRA, warna, sheet per subkegiatan | PARTIAL | Dua keluarga format resmi Renja/RKA/DPA (portrait) dan Renja/RKA perubahan/DPPA (landscape sebelum–sesudah), PDF serta Excel satu sheet per subkegiatan lulus phase20; mapping rekening–standar–aset divalidasi phase18; Renstra dan seluruh varian SPT/LRA resmi masih perlu finalisasi |
