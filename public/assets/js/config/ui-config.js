...
UIConfig.renja_kinerja={form:{elements:[sakipLookup("Sub Kegiatan","kd_sub_keg","sub_kegiatan_penugasan"),sakipInput("ID Sub Kegiatan Renstra","sub_kegiatan_renstra_id","number"),sakipLookup("Pohon Kinerja","pohon_kinerja_id","pohon_kinerja_dropdown"),sakipText("Indikator Keluaran","indikator_keluaran"),sakipInput("Satuan","satuan"),sakipInput("Target","target","number"),sakipInput("Lokasi","lokasi"),sakipInput("Kelompok Sasaran","kelompok_sasaran"),sakipInput("Pagu Indikatif","pagu_indikatif","number"),sakipInput("Prakiraan Maju Target","prakiraan_maju_target","number"),sakipInput("Prakiraan Maju Pagu","prakiraan_maju_pagu","number"),sakipInput("Sumber Dana","sumber_dana"),sakipText("Catatan Penting","catatan_penting"),sakipSelect("Status","status",["draft","diajukan","disetujui"])]}};
[
