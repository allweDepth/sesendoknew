...
class PengaturanModule {
    ...
    canEdit() {
        ...
        const role = (this.user.type_user || "")
            .toLowerCase()
            .replace(/\s+/g, "_");
    ...
    initUI(){
        ...
        const ranges=[
            "renja","dpa","rkpd","rka","renja_p","dppa",
            "kua_ppas","rapbd","rak","rkpd_perubahan",
            "kua_ppas_perubahan","apbd_perubahan","renstra"
        ];
    ...
    bindSubmit(){
        ...
        $("#form-pengaturan").on("submit",(e)=>{
            ...
            $("#form-pengaturan").serializeArray().forEach(item=>{
