...
$assert(str_contains($pdfTemplate,'$pdf->MultiCell(0,6,$renderText,0,$align'),'alignment metadata diterapkan oleh renderer PDF');
$assert(str_contains($pdfTemplate,'rtrim($text)."\\n"'),'baris terakhir justify tetap rata kiri');
