...
$profiles['iku_opd']=$sakipProfile('iku_opd_neo',['id','kode_iku','nama_indikator','satuan','polaritas','baseline','target_t1','target_t2','target_t3','target_t4','target_t5','target_akhir','frekuensi_pengukuran','status'],['kode_iku','nama_indikator','sumber_data'],['kode_iku'=>['required'],'nama_indikator'=>['required'],'satuan'=>['required']],['kd_wilayah','kd_opd']);
...
$profiles['iku_dropdown']=['table'=>'iku_opd_neo','primary_key'=>'id','where'=>['is_deleted'=>0],'dropdown'=>['value'=>'id','label'=>'nama_indikator','label_fields'=>['kode_iku','nama_indikator'],'searchable'=>['kode_iku','nama_indikator']]];
$profiles['pohon_kinerja_dropdown']=['table'=>'pohon_kinerja_neo','primary_key'=>'id','where'=>['is_deleted'=>0],'dropdown'=>['value'=>'id','label'=>'uraian_kinerja','label_fields'=>['kode_kinerja','uraian_kinerja'],'searchable'=>['kode_kinerja','uraian_kinerja']]];
$profiles['pk_dropdown']=['table'=>'perjanjian_kinerja_neo','primary_key'=>'id','where'=>['is_deleted'=>0],'dropdown'=>['value'=>'id','label'=>'nomor_dokumen','searchable'=>['nomor_dokumen']]];
