...
$profiles['kontrak'] = [
  ...
  'validation' => ['cara_pengadaan' => ['required'], 'jenis_pengadaan' => ['required'], 'nomor_kontrak' => ['required']],
  'req_filters' => ['kontrak_dpa' => ['where' => ['tahap' => 'dpa']], 'kontrak_dppa' => ['where' => ['tahap' => 'dppa']]],
  'dropdown' => ['value' => 'id', 'label' => 'nomor_kontrak'],
  'modes' => [
    'default' => [
      'select' => ['kontrak_neo.id', 'kontrak_neo.tahap', 'kontrak_neo.cara_pengadaan', 'kontrak_neo.jenis_pengadaan', 'kontrak_neo.tipe_swakelola', 'kontrak_neo.bentuk_kontrak', 'kontrak_neo.kd_sub_keg', 'kontrak_neo.nomor_spmk', 'kontrak_neo.nomor_kontrak', 'kontrak_neo.uraian_kontrak', 'rekanan_neo.nama_perusahaan AS penyedia', 'kontrak_neo.total_anggaran', 'kontrak_neo.nilai_hps', 'kontrak_neo.nilai_kontrak', 'kontrak_neo.tanggal_mulai', 'kontrak_neo.tanggal_selesai', 'kontrak_neo.status_kontrak'],
...
$profiles['struktur_jabatan_aktif_dropdown']=['table'=>'struktur_jabatan_opd_neo','primary_key'=>'id','where'=>['struktur_jabatan_opd_neo.kd_wilayah'=>'user','struktur_jabatan_opd_neo.kd_opd'=>'user','struktur_jabatan_opd_neo.tahun'=>'user','struktur_jabatan_opd_neo.status_jabatan'=>'AKTIF','struktur_jabatan_opd_neo.berlaku_mulai <='=>date('Y-m-d'),'struktur_jabatan_opd_neo.is_deleted'=>0],'join'=>[['table'=>'db_asn_pemda_neo','on'=>'db_asn_pemda_neo.id=struktur_jabatan_opd_neo.pegawai_id']],'dropdown'=>['value'=>'struktur_jabatan_opd_neo.id','label'=>'struktur_jabatan_opd_neo.nama_jabatan','label_fields'=>['struktur_jabatan_opd_neo.nama_jabatan','db_asn_pemda_neo.nama'],'searchable'=>['struktur_jabatan_opd_neo.nama_jabatan','db_asn_pemda_neo.nama']]];
