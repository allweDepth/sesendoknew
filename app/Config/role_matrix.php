...
return [
  ...
  'tapd'=>['label'=>'Tim Anggaran Pemerintah Daerah','scope'=>'satu wilayah dan tahun','actions'=>['view','approve','export']],
  'admin_opd'=>['label'=>'Admin OPD','scope'=>'satu OPD dan tahun','actions'=>['view','add','edit','delete']],
