...
<div id="crud-table-container">
  ...
  <div class="ui right floated basic icon buttons" style="margin-top:10px;">
    ...
    <!-- IMPORT -->
    <button class="ui button" data-ui="open-form" data-container="flyout" data-jns="import" data-tbl="<?= $tbl ?>"
  ...
  <div class="table-wrapper">
    ...
    <table class="ui very compact celled striped selectable table" id="tableSubKegiatan" data-table="<?= $tbl ?>"
      data-req="group_sub_kegiatan" data-group="kd_sub_keg" data-key="kd_sub_keg">
