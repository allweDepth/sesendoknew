...
return [
  ...
  '/kontrak/realization-contracts' => ['KontrakController', 'realizationContracts'],
  '/kontrak/realization-items' => ['KontrakController', 'realizationItems'],
  '/kontrak/realization/detail' => ['KontrakController', 'realizationDetail'],
  '/kontrak/realization/save' => ['KontrakController', 'saveRealization'],
  '/kontrak/realization/file/delete' => ['KontrakController', 'deleteRealizationDocument'],
  '/kontrak/realization/file/download' => ['KontrakController', 'downloadRealizationDocument'],
